...
if (!semver_1.default.satisfies(typescript_1.version, '>=4.1 <=4.5')) {
    console.warn('Please note that `@rtk-query/codegen-openapi` only has been tested with TS versions 4.1 to 4.5 - other versions might cause problems.');
}
let ts = false;
try {
...
if (commander_1.default.args.length === 0 || !/\.(jsx?|tsx?|jsonc?)?$/.test(configFile)) {
