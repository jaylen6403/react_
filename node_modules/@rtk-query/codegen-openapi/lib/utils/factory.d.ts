...
export declare const factory: {
    ...
    createStringLiteralFromNode(sourceNode: ts.PropertyNameLiteral, isSingleQuote?: boolean | undefined): ts.StringLiteral;
    ...
    createToken<TKind_4 extends ts.SyntaxKind.Unknown | ts.SyntaxKind.EndOfFileToken>(token: TKind_4): ts.Token<TKind_4>;
    ...
    createModifiersFromModifierFlags(flags: ts.ModifierFlags): ts.Modifier[];
    ...
    createTypeParameterDeclaration(name: string | ts.Identifier, constraint?: ts.TypeNode | undefined, defaultType?: ts.TypeNode | undefined): ts.TypeParameterDeclaration;
    ...
    createPropertyDeclaration(decorators: readonly ts.Decorator[] | undefined, modifiers: readonly ts.Modifier[] | undefined, name: string | ts.PropertyName, questionOrExclamationToken: ts.ExclamationToken | ts.QuestionToken | undefined, type: ts.TypeNode | undefined, initializer: ts.Expression | undefined): ts.PropertyDeclaration;
    updatePropertyDeclaration(node: ts.PropertyDeclaration, decorators: readonly ts.Decorator[] | undefined, modifiers: readonly ts.Modifier[] | undefined, name: string | ts.PropertyName, questionOrExclamationToken: ts.ExclamationToken | ts.QuestionToken | undefined, type: ts.TypeNode | undefined, initializer: ts.Expression | undefined): ts.PropertyDeclaration;
    ...
    createKeywordTypeNode<TKind_5 extends ts.KeywordTypeSyntaxKind>(kind: TKind_5): ts.KeywordTypeNode<TKind_5>;
    ...
    createImportTypeNode(argument: ts.TypeNode, qualifier?: ts.EntityName | undefined, typeArguments?: readonly ts.TypeNode[] | undefined, isTypeOf?: boolean | undefined): ts.ImportTypeNode;
    updateImportTypeNode(node: ts.ImportTypeNode, argument: ts.TypeNode, qualifier: ts.EntityName | undefined, typeArguments: readonly ts.TypeNode[] | undefined, isTypeOf?: boolean | undefined): ts.ImportTypeNode;
    ...
    createVariableStatement(modifiers: readonly ts.Modifier[] | undefined, declarationList: ts.VariableDeclarationList | readonly ts.VariableDeclaration[]): ts.VariableStatement;
    updateVariableStatement(node: ts.VariableStatement, modifiers: readonly ts.Modifier[] | undefined, declarationList: ts.VariableDeclarationList): ts.VariableStatement;
    ...
    createModuleDeclaration(decorators: readonly ts.Decorator[] | undefined, modifiers: readonly ts.Modifier[] | undefined, name: ts.ModuleName, body: ts.ModuleBody | undefined, flags?: ts.NodeFlags | undefined): ts.ModuleDeclaration;
    ...
    createImportDeclaration(decorators: readonly ts.Decorator[] | undefined, modifiers: readonly ts.Modifier[] | undefined, importClause: ts.ImportClause | undefined, moduleSpecifier: ts.Expression, assertClause?: ts.AssertClause | undefined): ts.ImportDeclaration;
    ...
    createAssertEntry(name: ts.AssertionKey, value: ts.StringLiteral): ts.AssertEntry;
    ...
    createExportDeclaration(decorators: readonly ts.Decorator[] | undefined, modifiers: readonly ts.Modifier[] | undefined, isTypeOnly: boolean, exportClause: ts.NamedExportBindings | undefined, moduleSpecifier?: ts.Expression | undefined, assertClause?: ts.AssertClause | undefined): ts.ExportDeclaration;
    ...
    createJSDocNonNullableType(type: ts.TypeNode): ts.JSDocNonNullableType;
    updateJSDocNonNullableType(node: ts.JSDocNonNullableType, type: ts.TypeNode): ts.JSDocNonNullableType;
    createJSDocNullableType(type: ts.TypeNode): ts.JSDocNullableType;
    ...
    createJSDocDeprecatedTag(tagName: ts.Identifier, comment?: string | ts.NodeArray<ts.JSDocComment> | undefined): ts.JSDocDeprecatedTag;
    updateJSDocDeprecatedTag(node: ts.JSDocDeprecatedTag, tagName: ts.Identifier, comment?: string | ts.NodeArray<ts.JSDocComment> | undefined): ts.JSDocDeprecatedTag;
    createJSDocOverrideTag(tagName: ts.Identifier, comment?: string | ts.NodeArray<ts.JSDocComment> | undefined): ts.JSDocOverrideTag;
    updateJSDocOverrideTag(node: ts.JSDocOverrideTag, tagName: ts.Identifier, comment?: string | ts.NodeArray<ts.JSDocComment> | undefined): ts.JSDocOverrideTag;
    ...
    createJsxAttribute(name: ts.Identifier, initializer: ts.StringLiteral | ts.JsxExpression | undefined): ts.JsxAttribute;
    updateJsxAttribute(node: ts.JsxAttribute, name: ts.Identifier, initializer: ts.StringLiteral | ts.JsxExpression | undefined): ts.JsxAttribute;
    ...
    createCatchClause(variableDeclaration: string | ts.VariableDeclaration | ts.BindingName | undefined, block: ts.Block): ts.CatchClause;
    ...
    createImmediatelyInvokedArrowFunction(statements: readonly ts.Statement[]): ts.CallExpression;
    createImmediatelyInvokedArrowFunction(statements: readonly ts.Statement[], param: ts.ParameterDeclaration, paramValue: ts.Expression): ts.CallExpression;
