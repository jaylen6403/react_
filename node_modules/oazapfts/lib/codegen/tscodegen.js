...
function createKeywordType(type) {
    switch (type) {
        ...
        case "object":
            return typescript_1.factory.createKeywordTypeNode(typescript_1.default.SyntaxKind.ObjectKeyword);
        case "string":
        ...
        case "null":
            return typescript_1.factory.createLiteralTypeNode(typescript_1.default.factory.createToken(typescript_1.default.SyntaxKind.NullKeyword));
    }
}
...
exports.keywordType = {
    ...
    object: typescript_1.factory.createKeywordTypeNode(typescript_1.default.SyntaxKind.ObjectKeyword),
    ...
    null: typescript_1.factory.createLiteralTypeNode(typescript_1.default.factory.createToken(typescript_1.default.SyntaxKind.NullKeyword)),
};
exports.modifier = {
...
function createTypeAliasDeclaration({ decorators, modifiers, name, typeParameters, type, }) {
    return typescript_1.factory.createTypeAliasDeclaration(decorators, modifiers, name, typeParameters, type);
}
...
function createFunctionDeclaration(name, { decorators, modifiers, asteriskToken, typeParameters, type, }, parameters, body) {
    return typescript_1.factory.createFunctionDeclaration(decorators, modifiers, asteriskToken, name, typeParameters, parameters, type, body);
}
...
function createMethod(name, { decorators, modifiers, asteriskToken, questionToken, typeParameters, type, } = {}, parameters = [], body) {
    return typescript_1.factory.createMethodDeclaration(decorators, modifiers, asteriskToken, name, createQuestionToken(questionToken), typeParameters, parameters, type, body);
}
exports.createMethod = createMethod;
function createParameter(name, { decorators, modifiers, dotDotDotToken, questionToken, type, initializer, }) {
    return typescript_1.factory.createParameterDeclaration(decorators, modifiers, dotDotDotToken, name, createQuestionToken(questionToken), type, initializer);
}
...
function createIndexSignature(type, { decorators, modifiers, indexName = "key", indexType = exports.keywordType.string, } = {}) {
    return typescript_1.factory.createIndexSignature(decorators, modifiers, [createParameter(indexName, { type: indexType })], type);
}
