...
function runtime(defaults) {
    ...
    function fetchJson(url, req = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const { status, contentType, data } = yield fetchText(url, Object.assign(Object.assign({}, req), { headers: Object.assign(Object.assign({}, req.headers), { Accept: "application/json" }) }));
    ...
    return {
        ...
        json(_a) {
            ...
            return Object.assign(Object.assign(Object.assign({}, req), (body && { body: JSON.stringify(body) })), { headers: Object.assign(Object.assign({}, headers), { "Content-Type": "application/json" }) });
        },
        form(_a) {
            var { body, headers } = _a, req = __rest(_a, ["body", "headers"]);
            return Object.assign(Object.assign(Object.assign({}, req), (body && { body: qs.form(body) })), { headers: Object.assign(Object.assign({}, headers), { "Content-Type": "application/x-www-form-urlencoded" }) });
        },
        multipart(_a) {
            var { body } = _a, req = __rest(_a, ["body"]);
            if (!body)
                return req;
