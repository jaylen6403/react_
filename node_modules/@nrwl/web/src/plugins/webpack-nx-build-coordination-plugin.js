...
class WebpackNxBuildCoordinationPlugin {
    ...
    apply(compiler) {
        compiler.hooks.beforeCompile.tapPromise('IncrementalDevServerPlugin', () => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            while (this.currentlyRunning === 'nx-build') {
                yield sleep(50);
            }
            this.currentlyRunning = 'webpack-build';
        }));
        compiler.hooks.done.tapPromise('IncrementalDevServerPlugin', () => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            this.currentlyRunning = 'none';
        }));
    }
