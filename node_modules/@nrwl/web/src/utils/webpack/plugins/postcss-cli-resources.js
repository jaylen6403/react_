...
function PostcssCliResources(options) {
    ...
    const process = (inputUrl, context, resourceCache) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
    ...
    return {
        ...
        Once(root) {
            ...
            return Promise.all(urlDeclarations.map((decl) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
