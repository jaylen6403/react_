...
function augmentIndexHtmlPlugin(generator) {
    ...
    return (html, options) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
...
function postTransformPlugin({ options, }) {
    return (html) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () { return options.postTransform ? options.postTransform(html) : html; });
}
