...
function update() {
    return (host, context) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        if (conflicts.length > 0) {
            context.logger.info((0, literals_1.stripIndent) `
      ...
      `);
        ...
        updates.push((0, workspace_1.formatFiles)());
        return (0, schematics_1.chain)(updates);
    });
}
...
function createBabelrc(host, context, babelrcPath, deps) {
    ...
    if (added > 1) {
        context.logger.warn((0, literals_1.stripIndents) `We created a babel config at ${babelrcPath} with both styled-components and emotion plugins.
...
const addEmotionPresetPackage = (0, workspace_1.addDepsToPackageJson)({}, {
