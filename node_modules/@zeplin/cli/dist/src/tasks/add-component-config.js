...
const addComponent = (ctx, task) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    logger_1.default.debug(`Add component config context: ${(0, text_1.stringify)({
    ...
    if (componentWithSameFile) {
        ...
        logger_1.default.debug(`Added new component ID into existing component entry ${(0, text_1.stringify)(componentWithSameFile)}`);
    }
    else {
        const newComponent = {
            path: ctx.file.path,
        ...
        logger_1.default.debug(`Added new component entry ${(0, text_1.stringify)(newComponent)}`);
    }
    logger_1.default.debug(`Updated config: ${(0, text_1.stringify)({ config })}`);
    yield (0, file_1.writeJsonIntoFile)(ctx.cliOptions.configFile, config);
});
