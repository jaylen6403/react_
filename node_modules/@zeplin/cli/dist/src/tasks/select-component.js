...
const checkComponentFlag = (ctx, task) => {
    if (ctx.cliOptions.componentId) {
        ...
        if (foundComponent) {
            logger_1.default.debug(`Found component via params: ${(0, text_1.stringify)(foundComponent)}`);
...
const select = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const choices = (0, array_1.sortByField)(ctx.components.map(c => ({ name: c.name, value: c })), "name");
