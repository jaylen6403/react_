...
const checkResourceFlags = (ctx, task) => {
    ...
    if (resourceId) {
        ...
        if (foundResource) {
            logger_1.default.debug(`Found resource via params: ${(0, text_1.stringify)(foundResource)}`);
...
const select = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const choices = (0, array_1.sortByField)(Object.values(ctx.resources).map(b => createChoice(b)), "name");
...
exports.selectResource = new task_1.Task({
    steps: [
        ...
        (0, task_1.transitionTo)(ui.retrieving),
        retrieveResources,
        checkResourceFlags,
        (0, task_1.transitionTo)(ui.select),
