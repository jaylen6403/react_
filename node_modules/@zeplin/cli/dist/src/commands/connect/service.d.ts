...
export declare class ConnectedComponentsService {
    ...
    uploadConnectedBarrels(connectedBarrelComponents: ConnectedBarrelComponents[], options: {
        force: boolean;
    }): Promise<void>;
    deleteConnectedBarrels(connectedComponents: ConnectedBarrels[]): Promise<void>;
    private upload;
    private delete;
}
