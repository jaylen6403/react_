...
class ConnectedComponentsService {
    ...
    uploadConnectedBarrels(connectedBarrelComponents, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const requiredScopes = ["write"];
            try {
                const { token } = yield this.authService.authenticate({ requiredScopes });
                yield this.upload(token, connectedBarrelComponents, options);
            }
            catch (error) {
    ...
    upload(authToken, connectedBarrelComponents, { force }) {
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all(connectedBarrelComponents.map((connectedBarrelComponent) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield Promise.all(connectedBarrelComponent.projects.map((pid) => __awaiter(this, void 0, void 0, function* () {
                    yield this.zeplinApi.uploadConnectedComponents(authToken, { barrelId: pid, barrelType: "projects" }, { items: connectedBarrelComponent.items, metadata: connectedBarrelComponent.metadata }, { forceOverwrite: force });
                })));
                yield Promise.all(connectedBarrelComponent.styleguides.map((stid) => __awaiter(this, void 0, void 0, function* () {
                    yield this.zeplinApi.uploadConnectedComponents(authToken, { barrelId: stid, barrelType: "styleguides" }, { items: connectedBarrelComponent.items, metadata: connectedBarrelComponent.metadata }, { forceOverwrite: force });
                })));
            })));
        });
    }
