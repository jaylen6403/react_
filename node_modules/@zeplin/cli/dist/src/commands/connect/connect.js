...
const getComponentFilePaths = (connectedBarrels) => ((0, array_1.flat)(connectedBarrels.map(f => f.items.map(c => (c.filePath ? path_1.default.resolve(c.filePath) : undefined)).filter(object_1.isDefined))));
...
const upload = (connectedBarrels, { force }) => __awaiter(void 0, void 0, void 0, function* () {
    logger_1.default.info("Connecting all Connected Components into Zeplin…");
    yield service.uploadConnectedBarrels(connectedBarrels, { force });
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (options.devMode) {
                ...
                yield upload(connectedBarrels, options);
            }
        }
        catch (error) {
