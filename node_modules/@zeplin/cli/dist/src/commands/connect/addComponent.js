...
function addComponent(options) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            logger_1.default.debug(`add-commponents options: ${(0, text_1.stringify)(options)}`);
            ...
            const [existingConfigFile] = yield (0, config_1.getComponentConfigFiles)([context.cliOptions.configFile])
                .catch(err => {
            ...
            if (!existingConfigFile) {
                ...
                return (0, commander_1.commandRunner)(() => (0, initialize_1.initialize)(options))();
            }
            ...
            yield workflow.run();
            logger_1.default.info((0, messages_1.addSummary)(context));
        }
        catch (error) {
