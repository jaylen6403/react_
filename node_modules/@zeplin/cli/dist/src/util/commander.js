...
const errorHandler = (error) => {
    ...
    if (errors_1.CLIError.isCLIError(error) && error.details) {
        ...
        if ((0, env_1.isVerbose)()) {
            logger_1.default.error(chalk_1.default.redBright((0, ts_dedent_1.default) `
            Details:
            ${errorDetails}`));
        }
        else {
    ...
    return (0, process_1.gracefulExit)(1);
};
function commandRunner(fn) {
    return (...args) => __awaiter(this, void 0, void 0, function* () {
        try {
            yield fn(...args);
            yield (0, process_1.gracefulExit)();
        }
        catch (e) {
