...
class ZeplinApi {
    ...
    uploadConnectedComponents(authToken, params, body, queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { barrelId, barrelType } = params;
                yield this.axios.put(`/public/cli/v2/${barrelType}/${barrelId}/connectedcomponents`, body, {
                    headers: { "Zeplin-Access-Token": authToken },
                    params: queryParams
                });
            }
    ...
    deleteConnectedComponents(authToken, params) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { barrelId, barrelType } = params;
                yield this.axios.delete(`/public/cli/v2/${barrelType}/${barrelId}/connectedcomponents`, {
                    headers: { "Zeplin-Access-Token": authToken }
                });
            }
            catch (error) {
