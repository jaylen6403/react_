...
function redactPersonalAccessToken(personalAccessToken) {
...
class AuthenticationService {
    ...
    authenticate({ requiredScopes = [], noBrowser = false } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.authentication) {
                ...
                if (tokenFromEnv) {
                    logger_1.default.debug(`Found access token from ZEPLIN_ACCESS_TOKEN env var. value: ${redactPersonalAccessToken(tokenFromEnv)}`);
                    this.authentication = {
                        token: tokenFromEnv,
                    ...
                    if (tokenFromFile) {
                        logger_1.default.debug(`Found access token from auth file. value: ${redactPersonalAccessToken(tokenFromFile)}`);
                        this.authentication = {
                            token: tokenFromFile,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.authentication) {
                ...
                try {
                    ...
                    if (!(0, error_1.isAuthenticationError)(err)) {
                        throw err;
                    }
                }
            }
    ...
    promptForBrowserLogin() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, open_1.default)(authUrl.toString());
