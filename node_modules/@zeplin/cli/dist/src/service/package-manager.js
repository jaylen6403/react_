...
function getLatestVersionUsingNpm(packageName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const out = (yield (0, command_1.runCommand)(`npm view ${packageName} versions --json`)) || "[]";
...
function getLatestVersion(packageName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return yield (0, latest_version_1.default)(packageName);
        }
        catch (err) {
...
function installPackages(packages, { installGlobal = false } = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const yarn = (0, has_yarn_1.default)();
        const args = [];
        ...
        yield (0, command_1.runCommand)(command);
    });
}
