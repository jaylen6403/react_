...
function detectGit(params) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const gitConfig = yield (0, parse_git_config_1.default)({ expandKeys: true, path: params === null || params === void 0 ? void 0 : params.path });
        ...
        if (remoteUrl) {
            ...
            const { owner, name: repository, source, resource: host, protocol } = (0, git_url_parse_1.default)(remoteUrl);
            let config;
            ...
            logger_1.default.debug(`Git configuration: ${(0, text_1.stringify)({
                owner,
                repository,
                source,
                host,
