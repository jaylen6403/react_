...
function storybookConfiguratorFactory() {
    return (packageJson) => {
        ...
        if (packageJson) {
            const [foundVersion] = storybook_1.supportedStorybookFrameworks.map(d => (0, dependency_1.getDependencyVersion)(packageJson, d));
            if (foundVersion && (0, semver_1.gt)((0, semver_1.minVersion)(foundVersion), (0, semver_1.minVersion)("4"))) {
                config.format = "new";
            }
