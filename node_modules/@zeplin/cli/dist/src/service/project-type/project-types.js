...
exports.supportedProjectTypes = [
    {
        ...
        matcher: (0, js_dependency_1.jsDependencyMatcherFactory)(["react", "react-native"]),
        installPackages: [
    ...
    },
    {
        ...
        matcher: (0, js_dependency_1.jsDependencyMatcherFactory)(["preact"]),
        installPackages: [
            "@zeplin/cli-connect-react-plugin"
        ]
    },
    {
        ...
        matcher: (0, js_dependency_1.jsDependencyMatcherFactory)(["@angular/core"]),
        installPackages: [
    ...
    },
    {
        ...
        matcher: (0, js_dependency_1.jsDependencyMatcherFactory)(["vue", "nuxt"]),
        installPackages: [
    ...
    },
    {
        ...
        matcher: (0, js_dependency_1.jsDependencyMatcherFactory)(storybook_1.supportedStorybookFrameworks),
        installPackages: [
            "@zeplin/cli-connect-storybook-plugin"
        ],
        configurator: (0, storybook_2.storybookConfiguratorFactory)()
    }
];
